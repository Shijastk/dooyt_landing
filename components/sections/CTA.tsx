      ...
      <div className="container-page">
        <div className="relative lg:pt-24">
          ...
          <Image
            ...
            placeholder="blur"
            sizes="420px"
            className="pointer-events-none absolute bottom-0 bottom-0 right-6 hidden h-auto w-[380px] lg:block xl:right-16 xl:w-[450px]"
          />

          {/* White gradient fading the card (and the phone's base) into the page */}
          <div
            className="pointer-events-none absolute inset-x-0 bottom-[-10px] h-1/3 rounded-b-3xl bg-gradient-to-t from-white to-transparent"
            aria-hidden
          />
        </div>
      </div>
